...
def get_raw_source_files(
    ...
    source_files.append(filter_source_files(directory_entries, source_dir, '.c'))
    header_files.append(filter_source_files(directory_entries, source_dir, '.h'))

    for directory in directories:
        get_raw_source_files(source_dir + '/' + directory, source_files, header_files)


def get_source_files_list(source_dir: str) -> tuple:
    source_files = []
    header_files = []

    get_raw_source_files(source_dir, source_files, header_files)
